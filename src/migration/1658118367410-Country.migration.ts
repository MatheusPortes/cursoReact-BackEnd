...
export class Country_migration1658118367410 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable( new Table({
            ...
            columns: [
                ...
                {
                    name: 'bacen', //Bacen (código do País pela tabela do Banco Central/IBGE)
                    type: 'integer',
                },
                {
                    name: 'created_at',
        ...
        await queryRunner.query(`INSERT INTO "country" (id, name, name_tpbr, initials, bacen) VALUES
